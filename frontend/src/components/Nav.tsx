...
export default function Nav() {
  ...
  const isTutorActive = isActive("/tutor");
  ...
  return (
    <nav className="bg-[#0a0f1e]/95 backdrop-blur-md border-b border-white/[0.06] sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-6">
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center shadow-lg shadow-blue-900/40 group-hover:shadow-blue-700/50 group-hover:scale-105 transition-all duration-200">
        ...
        {!loading && user && !['/', '/login', '/register'].includes(pathname) && (
          <div className="hidden md:flex items-center gap-1 flex-1 justify-center">
            ...
            {/* AI Tutor — special glowing button */}
            <Link
              href="/tutor"
              className={cn(
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className={isTutorActive ? "text-white" : "text-violet-400"}>
              ...
              AI Tutor
              {!isTutorActive && (
                <span className="text-[9px] font-bold bg-violet-500/20 text-violet-300 border border-violet-500/30 px-1.5 py-0.5 rounded-full">AI</span>
              )}
            </Link>
          </div>
        )}
        ...
        <div className="flex items-center gap-2 shrink-0">
          {!loading && (
            user ? (
                ...
                {dropdownOpen && (
                  <div className="absolute right-0 top-full mt-2 w-60 bg-[#0d1628] border border-white/[0.1] rounded-2xl shadow-2xl shadow-black/60 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                    ...
                    <div className="py-1.5">
                      <Link href="/profile" className="flex items-center gap-3 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-white/[0.06] transition-colors">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><circle cx="7.5" cy="5" r="2.5" stroke="currentColor" strokeWidth="1.3" fill="none" /><path d="M2 13c0-3.038 2.462-5.5 5.5-5.5S13 9.962 13 13" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" fill="none" /></svg>
                        Profile Details
                      </Link>
                      <Link href="/analytics" className="flex items-center gap-3 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-white/[0.06] transition-colors">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M2 11l3-3.5 2.5 2L10 5l3 3.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" fill="none" /></svg>
                        My Progress
                      </Link>
                      <Link href="/learn" className="flex items-center gap-3 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-white/[0.06] transition-colors">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M2 3a1 1 0 011-1h9a1 1 0 011 1v8a1 1 0 01-1 1H3a1 1 0 01-1-1V3z" stroke="currentColor" strokeWidth="1.3" fill="none" /><path d="M5 6h5M5 8.5h3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>
                        My Subjects
                      </Link>
                      <Link href="/preferences" className="flex items-center gap-3 px-4 py-2.5 text-sm text-white/70 hover:text-white hover:bg-white/[0.06] transition-colors">
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><circle cx="7.5" cy="7.5" r="5.5" stroke="currentColor" strokeWidth="1.3" fill="none" /><path d="M7.5 5v2.5l1.5 1.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /></svg>
                        Edit Preferences
                      </Link>
                    </div>
                    ...
                    <div className="border-t border-white/[0.07] py-1.5">
                      ...
                      >
                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><path d="M6 2H3a1 1 0 00-1 1v9a1 1 0 001 1h3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" /><path d="M10 10l3-2.5L10 5M13 7.5H6" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" /></svg>
                        Sign Out
                      </button>
                    </div>
                  </div>
              ...
              <>
                <Link href="/login" className="text-sm text-white/60 hover:text-white px-4 py-2 rounded-lg hover:bg-white/[0.06] transition-colors font-medium">
                  Sign in
                </Link>
                <Link href="/register" className="text-sm bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-500 transition-colors shadow-lg shadow-blue-900/40">
                  Get started
                </Link>
              </>
            )
